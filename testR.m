%{.
 clc; clear all;
jpgFiles = dir('E:\Anik Alvi\unsupervised-face-mask-detection\mtcnn-face-detection\code\mtcnn\datasetR\*.jpg');
...
for k = 1:length(jpgFiles)
    ...
    cd 'E:\Anik Alvi\unsupervised-face-mask-detection\mtcnn-face-detection\code\mtcnn\datasetR\'; 
    im = imread(filename);
    ...
    if numel(scores)==1
        ...
        %imshow(imcropped);
        cd 'E:\Anik Alvi\unsupervised-face-mask-detection\mtcnn-face-detection\code\mtcnn\croppedR\';
