...
jpgFiles = dir('E:\Anik Alvi\unsupervised-face-mask-detection\mtcnn-face-detection\code\mtcnn\gabor2\*.jpg');
...
for k = 1:length(jpgFiles)
    ...
    cd 'E:\Anik Alvi\unsupervised-face-mask-detection\mtcnn-face-detection\code\mtcnn\gabor2\'; 
...
save('E:\Anik Alvi\unsupervised-face-mask-detection\mtcnn-face-detection\code\mtcnn\gabor2\Exp0.mat', 'P1', 'P2', 'A');
