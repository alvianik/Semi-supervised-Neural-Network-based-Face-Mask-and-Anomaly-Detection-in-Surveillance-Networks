...
jpgFiles = dir('E:\Anik Alvi\unsupervised-face-mask-detection\mtcnn-face-detection\code\mtcnn\gaborR\*.jpg');
...
for k = 1:length(jpgFiles)
    ...
    cd 'E:\Anik Alvi\unsupervised-face-mask-detection\mtcnn-face-detection\code\mtcnn\gaborR\'; 
...
save('E:\Anik Alvi\unsupervised-face-mask-detection\mtcnn-face-detection\code\mtcnn\gaborR\Exp0.mat', 'P1', 'P2', 'A');
